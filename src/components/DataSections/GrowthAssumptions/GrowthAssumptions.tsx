...
import { SectionLabel, DerivedStat } from "../../primitives";
import type { GrowthAssumptionsProps } from "./GrowthAssumptions.types.ts";

export function GrowthAssumptions({
  inp, growthPeriod, growthYears, epsGrowthHistory, onGrowthPeriodChange,
