...
import { DEFAULT_FILTERS, filtersEqual, isDefault, CAPS, EXCHANGES, TUP_RANGES } from "./DiceFilterBar.helpers.ts";
import type { DiceFilterBarProps } from "./DiceFilterBar.types.ts";
import type { MarketCapTier, ExchangeFilter, TupRangeFilter } from "../../lib/types.ts";

export function DiceFilterBar({ isOpen, activeFilters, onApply, onReset, variant = "compact" }: DiceFilterBarProps) {
  const [pending, setPending] = useState(activeFilters);
